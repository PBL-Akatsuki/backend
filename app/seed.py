...
# def upload_neoverse_logs(db: Session):
#     """ Uploads neovese_logs.csv to the database if not already inserted """
#     existing_logs = db.query(NeoverseLog).first()
#     if existing_logs:
...
#             __file__))  # Get the directory of seed.py
#         # Construct absolute path
#         csv_file = os.path.join(script_dir, "neovese_logs.csv")
...
#         # --- Check if Neoverse logs are already seeded ---
#         existing_log = db.query(NeoverseLog).first()
#         if existing_log:
#             print("Neoverse logs already exist. Skipping CSV import.")
#             return

#         print("Seeding Neoverse logs from CSV...")
